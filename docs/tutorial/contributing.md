...
This tutorial will guide you through on how to set up a working environment for developing `pynxtools-mpes`.
...
- how to setup your environment for developing `pynxtools-mpes`
- how to make changes to the software
- how to test the software
- how to contribute on GitHub
- how to use `pynxtools-mpes` as a NOMAD plugin

## Contributing

??? info "Structure of the `pynxtools-mpes` repository"
    The software tools are located inside `src/pynxtools_mpes`. They are shipped with unit tests located in `tests`.
...
```console
git clone https://github.com/FAIRmat-NFDI/pynxtools-mpes.git \\
    --branch main \\
...
## Developing `pynxtools-mpes` as a NOMAD plugin

If you plan to contribute to the NOMAD plugin functionality of pynxtools-mpes, it often makes sense to use the NOMAD development environment called `nomad-distro-dev`. You can learn more in the [NOMAD documentation](https://nomad-lab.eu/prod/v1/staging/docs/howto/develop/setup.html#nomad-distro-dev-development-environment-for-the-core-nomad-package-and-nomad-plugins).

## Troubleshooting

If you face any issues with the tool or when setting up the development environment, please create a new [Github Issue](https://github.com/FAIRmat-NFDI/pynxtools-mpes/issues/new?template=bug.yaml).
