...
This example demonstrates how NOMAD can convert, standardize, and store multi photoemission spectroscopy (MPES) experimental data. It contains four major examples:
...
For questions regarding the experiment or this specific example
refer to the [Dynamics of Correlated Materials](https://pc.fhi-berlin.mpg.de/docm/) or [Structural & Electronic Surface Dynamics](https://pc.fhi-berlin.mpg.de/sesd/) working group at the Fritz-Haber Institute Berlin.

For general questions regarding the MPES pipeline and if you're interested in building one for your
own research workflow you may contact [Lukas Pielsticker](https://www.fairmat-nfdi.eu/fairmat/fairmat_/fairmatteam) or [Laurenz Rettig](https://www.fairmat-nfdi.eu/fairmat/fairmat_/fairmatteam) from the FAIRmat consortium.
